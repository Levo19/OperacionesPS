...
Reporte dueño: pase VARIOS→Overland (12-ago) en S/0. Causa:  solo cobraba  (el fix de julio dejó  fuera) y  no aceptaba monto manual. Fix: agencia Y libre cobran su tarifa vigente × pax (aliado/comisionado siguen en PAX);  opcional (manual > 0 gana, cualquier origen — cubre texto libre); modal con campo **Cobro al origen (S/)** editable con auto en vivo. Backfill 3 pases (S/120). REGLA dueño: todo contacto tiene precio_defecto y se respeta, con opción manual. LECCIÓN: al arreglar UN tipo cobrable, revisar los demás tipos en el mismo helper; y las anclas de edición tipo  se repiten entre modales — verificar en qué función cayó el replace.
